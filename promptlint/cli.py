...
import argparse, sys
from promptlint.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="promptlint", description="PROMPTLINT — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from promptlint.mcp_server import serve
        return serve()
    if args.cmd == "scan":
