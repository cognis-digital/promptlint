"""Native cognis-connect emit for promptlint — forward findings to any platform.

Maps promptlint's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    promptlint ... --format json | promptlint-emit --to stix
    promptlint-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
